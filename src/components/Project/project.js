      ...
      <div className="mainContent">
        <div onClick={(e) => animationT(e)} className="elements  image-bottom">
          ...
          <div className="text">
            ...
            <p>
              Shows realtime covid-19 status of Nepal. Total infected , total
              recovered and total deaths data is shown district and province
              wise both. CharJs is used to visualize the data in graphs.
            </p>
            <img
              className="svg"
            ...
            <div className="github">
              ...
              <a
                href="https://github.com/Paankajshah/CoronaTrackerNepal"
                target="_blank"
              >
        ...
        <div className="elements">
          ...
          <div className="text">
            ...
            <p>
              A simple login and signup form implementaion developed using MERN
              stack (mongodb, express, React and NodeJs). A mail server is used
              to send otp code at the time of registration and only lets the
              verified user to login. Bootstrap is used for styling the page.
            </p>
            <img
              className="svg"
              src="https://img.shields.io/badge/Platform-Web-brightgreen.svg"
            ...
            <div className="github">
              view <FontAwesomeIcon icon={faCode} spin color="blue" /> at Github{" "}
              <a
                href="https://github.com/Paankajshah/mern_otpbased_login-signup_using_react_and_redux"
                target="_blank"
              >
                <img className="github-icon" src="/images/github-brands.svg" />
              </a>
        ...
        <div className="elements image-bottom">
          ...
          <div className="text">
            ...
            <p>
              A lottery system developed using React and truffle suite. any user
              can buy a lottery paying 1ETH and as many times they want and wait
              for the result, admin decides when to end the lottery and smart
              contract automatically picks the winner using Keccack algorithm.
            </p>
            <img
              className="svg"
              src="https://img.shields.io/badge/Platform-Web-brightgreen.svg"
        ...
        <div className="elements">
          ...
          <div className="text">
            ...
            <p>
              A full stack blockchain project where testing framework and asset
              pipeline for blockchains using the Ethereum Virtual Machine (EVM)
              is implemented from truffle box, nodeJs is used to store the
              information about voter and candidate and React is used for the
              frontend. 2FA is enabled in this project.
            </p>
            <img
              className="svg"
              src="https://img.shields.io/badge/Platform-Web-brightgreen.svg"
            ...
            <div className="github">
              view <FontAwesomeIcon icon={faCode} spin color="blue" /> at Github{" "}
              <a href="https://github.com/Paankajshah/Voting" target="_blank">
                <img className="github-icon" src="/images/github-brands.svg" />
              </a>
            </div>
        ...
        <div className="elements image-bottom">
          <div className="image-hidden">
            <img src="/images/port.JPG" alt="no image" />{" "}
          </div>
          <div className="text">
            <h1>My Portfolio</h1>

            <p>
              A technical portfolio developed using React and pure CSS. For
              animation gsap library is used. All the components in the project
              are functional component i.e React hooks is used all over in this
              project A single page application where all the information about
              me and my projects is mentioned.
            </p>
            <img
              className="svg"
              src="https://img.shields.io/badge/Platform-Web-brightgreen.svg"
            ...
            <img
              className="svg"
              src="https://img.shields.io/github/package-json/v/pankajshah1/pankajshah1.github.io"
              alt="Version-1.0.0"
              height="20px"
              width="50px"
            />
            <img
              className="svg"
              src="https://img.shields.io/github/repo-size/pankajshah1/pankajshah1.github.io"
              alt="Repo_Size-1.69-MB"
            />
            <img
              className="svg svg-long svg-extraLong"
              src="https://img.shields.io/badge/Languages-HTML,_CSS,_JS-red.svg"
